    ...
    for line in Lines:
      ...
      for lines in Line:
        ...
        if __name__ == '__main__':
          Process(target=add(line, lines)).start()
  def start(id):
    if __name__ == '__main__':
      Process(target=spam.add(id)).start()
def rename(name):
  for line in Lines:
...
def ask():
  ...
  print()
  print('[ ', end='', flush=True)
  cprint('2', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Add User To The Spammer', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('3', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Remove User From Spammer', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('4', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Remove User From All Groupchats', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('5', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Delete Groupchats', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('6', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Rename Groupchats', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('7', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
  print('Spam User', end='', flush=True)
  print()
  print()
  print('[ ', end='', flush=True)
  cprint('8', 'green', end='', flush=True)
  print(' ] ', end='', flush=True)
